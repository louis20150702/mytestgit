...
public class AlarmKlaxon extends Service {
    ...
    private PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String ignored) {
            ...
            if (TelephonyManager.getPhoneCount() > 1) {
                int state0 = TelephonyManager.getDefault(0).getCallState();
                int state1 = TelephonyManager.getDefault(1).getCallState();
                /* Modify at 2013-02-06 , for fix bug 123321 start */
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // newest state.
        mInitialCallState = TelephonyManager.getDefault(0).getCallState();
        if (TelephonyManager.getPhoneCount() > 1) {
            mInitialCallState1 = TelephonyManager.getDefault(1).getCallState();
        }
        return START_STICKY;
    }
    ...
    public boolean checkisVTCall() {
        isVTCall = mTelephonyManager.isVTCall();
