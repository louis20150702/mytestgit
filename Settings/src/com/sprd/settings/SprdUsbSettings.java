...
//        }
    ...
    private void updateState(Object[] available, Object[] tethered,
        ...
        if (usbTethered) {
            ...
            updateUI();
        } else if ((usbErrored || usbError != ConnectivityManager.TETHER_ERROR_NO_ERROR
                || UsbManager.USB_FUNCTION_MASS_STORAGE.equals(getCurrentFunction()) )
