...
public class NetworkManagementSettings extends PreferenceActivity implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (KEY_NETWORK_TYPE_SELECT.equals(key)) {
            ...
            mConnectivity.setNetworkPreference(value);
        }
        return true;
    }
    ...
    private void initNetworkTpyPreference() {
        ...
        int networkValue = ConnectivityManager.getDefaultNetworkType(mNerworkPreferenceType);
        pref.setValue(String.valueOf(networkValue));
    }
}
