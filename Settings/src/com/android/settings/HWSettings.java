 ...
 */
public class HWSettings extends PreferenceActivity
    ...
    private BasePreferenceFragment mAllSettingsFragment;
    private BasePreferenceFragment mGeneralSettingsFragment;
    private ViewPager mViewPager;
    private SettingsPagerAdapter mPagerAdapter;
    private int curTabIndex=0;
    private static final String SAVE_KEY_CURRENT_TAB = "com.android.settings.CURRENT_TAB";   //wangkaifeng tab settings
    public static boolean HW_SETTINGS = FeatureOption.PRJ_FEATURE_HW_SETTINGS;
    private static final int TAB_INDEX_NETWORKS = 0;
    private static final int TAB_INDEX_SYSTEM = 1;
    private int SETTINGS_TITLE_ALL = 1;
    private int SETTINGS_TITLE_GENERAL = 0;
//    private List<Header> mHeaders;
    ...
    */
    ...
    /** @} */
		...
		if(HW_SETTINGS){  //wangkaifeng tab settings
			...
			if (this.toString().contains(".HWSettings@") ) {
				...
				//revo lyq             
				int TYPELCD    = SystemProperties.getInt("qemu.sf.lcd_density", SystemProperties.getInt("ro.sf.lcd_density", 240));
				if(TYPELCD==160)
				{
     				tabHeight=52;
				}
    ...
    private void createFragments(){
        ...
        Fragment localFragment1 = this.mFragmentManager.findFragmentByTag("com.android.settings.HWAllSettingsFragment");
        if (localFragment1 != null)
          localFragmentTransaction.remove(localFragment1);
        Fragment localFragment2 = this.mFragmentManager.findFragmentByTag("com.android.settings.HWGeneralSettingsFragment");
	    ...
	    localFragmentTransaction.add(R.id.tab_pager, this.mGeneralSettingsFragment, "com.android.settings.HWGeneralSettingsFragment");
	    ...
	    localFragmentTransaction.add(R.id.tab_pager, this.mAllSettingsFragment, "com.android.settings.HWAllSettingsFragment");
    ...
    Log.d("dingjingliang", "getFragment: paramInt="+paramInt);
      BasePreferenceFragment localBasePreferenceFragment = this.mAllSettingsFragment;
      if (paramInt == this.SETTINGS_TITLE_GENERAL)
        localBasePreferenceFragment = this.mGeneralSettingsFragment;
      return localBasePreferenceFragment;
    }

    private class SettingsPageChangeListener implements ViewPager.OnPageChangeListener{
    	private SettingsPageChangeListener()
		{
		}
		...
		{
			curTabIndex = paramInt;
		    if ((mActionBar.getNavigationMode() == 2) && (paramInt != mActionBar.getSelectedNavigationIndex()))
    ...
    private class SettingsPagerAdapter extends PagerAdapter
    {
      ...
      public void destroyItem(View paramView, int paramInt, Object paramObject)
      {
        if (this.mCurTransaction == null)
          this.mCurTransaction = HWSettings.this.mFragmentManager.beginTransaction();
        this.mCurTransaction.hide((Fragment)paramObject);
      }

      public void finishUpdate(View paramView)
      {
    	  Log.d("dingjingliang", "finishUpdate");
        if (this.mCurTransaction != null)
        {
          this.mCurTransaction.commitAllowingStateLoss();
          this.mCurTransaction = null;
          HWSettings.this.mFragmentManager.executePendingTransactions();
        }
      }

      public int getCount()
      {
        return 1 + HWSettings.this.SETTINGS_TITLE_ALL;
      }
      ...
      public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
      {
		...
		Fragment localFragment = getFragment(paramInt);
		mCurTransaction.show(localFragment);
...
//		mHeaders = null;		  
    ...
    public void invalidateHeaders() {
		...
		int index = mActionBar.getSelectedTab().getPosition();
		if(index == TAB_INDEX_SYSTEM){			
			Fragment fragment= getFragment(index);
			if(fragment != null && fragment.getView()!=null){
				((BasePreferenceFragment)fragment).updateHeaders();
			}
		}
    }
...
//        mHeaders = headers;
    ...
    public void updateHeaderList(List<Header> target) {
        ...
        int i = 0;
        boolean IsSupVoice =  this.getResources().getBoolean(com.android.internal.R.bool.
    ...
    public static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        private final AirplaneModeEnablerNew mAirplaneModeEnablerNew;  //wangkaifeng tab settings 
        ...
        static int getHeaderType(Header header) {
            if (header.id == R.id.wifi_settings || header.id == R.id.bluetooth_settings 
            	/*|| header.id == R.id.toggle_airplane*/) {
        ...
        public HeaderAdapter(Context context, List<Header> objects,
            ...
            mAirplaneModeEnablerNew = new AirplaneModeEnablerNew(context, new Switch(context));
            /* SPRD: add for tab style @{ */
...
//                return view;
            ...
            switch (headerType) {
                ...
                case HEADER_TYPE_SWITCH:
                    ...
                    if (header.id == R.id.wifi_settings) {
                        ...
                        mAirplaneModeEnablerNew.setSwitch(holder.switch_);
                    } */else {
        ...
        public void resume() {
            ...
            mAirplaneModeEnablerNew.resume();
        }

        public void pause() {
            mWifiEnabler.pause();
            mBluetoothEnabler.pause();
            mAirplaneModeEnablerNew.pause();
        }
     ...
     */
    public static class BluetoothSettingsActivity extends HWSettings { /* empty */ }
    public static class WirelessSettingsActivity extends HWSettings { /* empty */ }
    public static class TetherSettingsActivity extends HWSettings { /* empty */ }
    public static class VpnSettingsActivity extends HWSettings { /* empty */ }
    public static class DateTimeSettingsActivity extends HWSettings { /* empty */ }
    public static class StorageSettingsActivity extends HWSettings { /* empty */ }
    public static class WifiSettingsActivity extends HWSettings { /* empty */ }
    public static class HotspotSettingsActivity extends HWSettings { /* empty */ }
    public static class WifiP2pSettingsActivity extends HWSettings { /* empty */ }
    public static class InputMethodAndLanguageSettingsActivity extends HWSettings { /* empty */ }
    public static class KeyboardLayoutPickerActivity extends HWSettings { /* empty */ }
    public static class InputMethodAndSubtypeEnablerActivity extends HWSettings { /* empty */ }
    public static class SpellCheckersSettingsActivity extends HWSettings { /* empty */ }
    public static class LocalePickerActivity extends HWSettings { /* empty */ }
    public static class UserDictionarySettingsActivity extends HWSettings { /* empty */ }
    public static class SoundSettingsActivity extends HWSettings { /* empty */ }
    public static class DisplaySettingsActivity extends HWSettings { /* empty */ }
    public static class DeviceInfoSettingsActivity extends HWSettings { /* empty */ }
    public static class ApplicationSettingsActivity extends HWSettings { /* empty */ }
    public static class ManageApplicationsActivity extends HWSettings { /* empty */ }
    public static class AppOpsSummaryActivity extends HWSettings {
        @Override
    ...
    public static class StorageUseActivity extends HWSettings { /* empty */ }
    public static class DevelopmentSettingsActivity extends HWSettings { /* empty */ }
    public static class AccessibilitySettingsActivity extends HWSettings { /* empty */ }
    public static class CaptioningSettingsActivity extends HWSettings { /* empty */ }
    public static class SecuritySettingsActivity extends HWSettings { /* empty */ }
    public static class LocationSettingsActivity extends HWSettings { /* empty */ }
    public static class PrivacySettingsActivity extends HWSettings { /* empty */ }
    public static class RunningServicesActivity extends HWSettings { /* empty */ }
    public static class ManageAccountsSettingsActivity extends HWSettings { /* empty */ }
    public static class PowerUsageSummaryActivity extends HWSettings { /* empty */ }
    public static class AccountSyncSettingsActivity extends HWSettings { /* empty */ }
    public static class AccountSyncSettingsInAddAccountActivity extends HWSettings { /* empty */ }
    public static class CryptKeeperSettingsActivity extends HWSettings { /* empty */ }
    public static class DeviceAdminSettingsActivity extends HWSettings { /* empty */ }
    public static class DataUsageSummaryActivity extends HWSettings { /* empty */ }
    public static class AdvancedWifiSettingsActivity extends HWSettings { /* empty */ }
    public static class TextToSpeechSettingsActivity extends HWSettings { /* empty */ }
    public static class AndroidBeamSettingsActivity extends HWSettings { /* empty */ }
    public static class WifiDisplaySettingsActivity extends HWSettings { /* empty */ }
    public static class DreamSettingsActivity extends HWSettings { /* empty */ }
    public static class NotificationStationActivity extends HWSettings { /* empty */ }
    public static class UserSettingsActivity extends HWSettings { /* empty */ }
    public static class NotificationAccessSettingsActivity extends HWSettings { /* empty */ }
    public static class UsbSettingsActivity extends HWSettings { /* empty */ }
    public static class TrustedCredentialsSettingsActivity extends HWSettings { /* empty */ }
    public static class PaymentSettingsActivity extends HWSettings { /* empty */ }
    public static class PrintSettingsActivity extends HWSettings { /* empty */ }
    public static class PrintJobSettingsActivity extends HWSettings { /* empty */ }
    ...
    public static class UninstallApplicationsActivity extends HWSettings { /* empty */ }
    /* @} */
}
