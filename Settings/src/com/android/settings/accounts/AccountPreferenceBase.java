        ...
        if (mAuthenticatorHelper.containsAccountType(accountType)) {
            ...
            try {
                ...
                if (desc != null && desc.accountPreferencesId != 0) {
					...
					//stvelzhang20150129 modify for advan settings account Theme
                    if (com.android.settings.Settings.UNIVERSEUI_SUPPORT || com.android.featureoption.FeatureOption.PRJ_FEATURE_MULTI_PRJ_CUSTOMER_ADVAN_BASE ) {
                        authContext.setTheme(android.R.style.Theme_Holo_Light);
                    }
