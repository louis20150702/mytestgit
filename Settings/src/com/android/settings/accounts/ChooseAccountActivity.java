...
public class ChooseAccountActivity extends PreferenceActivity {
    ...
    /**
     * SPRD:
     * Modify this method for hide sprd account in settings.
     * @{
     */
    private void updateAuthDescriptions() {
		...
		if(FeatureOption.PRJ_FEATURE_PRJ_DIKA_P4511||FeatureOption.PRJ_FEATURE_MULTI_PRJ_TRX_VID_Z40NOVA||FeatureOption.PRJ_FEATURE_MULTI_PRJ_CUSTOMER_SPICES_BASE){
			Log.i("lyxx","eee  = " + mAuthDescs[i].type);
			if(mAuthDescs[i].type.equals("com.sprd.caldav.account") || mAuthDescs[i].type.equals("com.sprd.carddav.account")){
				continue ; 
			}
		}
