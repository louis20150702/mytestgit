...
/* SPRD: add uui style for bug 300619 @{ */
    ...
    public static class ConfirmLockPasswordFragment extends Fragment implements OnClickListener,
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(UNIVERSEUI_SUPPORT) {
                view = inflater.inflate(R.layout.confirm_lock_password_uui, null);
            } else {
                view = inflater.inflate(R.layout.confirm_lock_password, null);
            }
            /* @} */
            // Disable IME on our window since we provide our own keyboard
