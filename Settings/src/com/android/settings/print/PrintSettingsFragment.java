...
public class PrintSettingsFragment extends SettingsPreferenceFragment implements DialogCreatable {
    ...
    static final String EXTRA_PRINT_JOB_ID = "EXTRA_PRINT_JOB_ID";
     ...
     boolean mEnabled = false;/*!FeatureOption.PRJ_FEATURE_MULTI_PRJ_TRX_VID_Z40NOVA;*/ //revo lgz Cloud Print default false 
    ...
    private String PREFS_NAME = "com.android.settings.print";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (UNIVERSEUI_SUPPORT) {
            ...
            textView.setTextColor(res.getColor(R.color.text_Empty_color_newui));
    ...
    private void updateServicesPreferences() {
        ...
        for (int i = 0; i < installedServiceCount; i++) {
	     ...
	     serviceEnabled = settings.getBoolean("printcheck", mEnabled);
