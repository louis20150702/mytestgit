...
public class ToggleCaptioningPreferenceFragment extends Fragment {
    private static final float DEFAULT_FONT_SIZE = 42f;
    ...
    /* SPRD: for Bug260848,when the screen changed, the image size inappropriate  @{ */
    @Override
    public void onConfigurationChanged(Configuration newConfig) {
        // TODO Auto-generated method stub
        super.onConfigurationChanged(newConfig);
        float height = getActivity().getResources().getDimension(R.dimen.captioning_preview_height);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mImage = (FrameLayout)view.findViewById(R.id.fl_caption_image);
