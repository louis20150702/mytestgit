...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    /*
     * SPRD: Add 20140224 Spreadst of bug282732, remove tts_settings_preference
     * if TtsEngine is lack @{
     */
    private static final String TTS_PREFERENCE_SCREEN =
    ...
    // SPRD:ADD set system can support spread pwd function or not.
    private boolean mIsSupportSpreakPWD = false;
     ...
     * if TtsEngine is lack @{
     */
    private PreferenceScreen mTtsPreferenceScreen;
    /* @} */
    ...
    private void initializeAllPreferences() {
        ...
        // SPRD: DELETE remove the rotation preference.
        mSystemsCategory.removePreference(mToggleLockScreenRotationPreference);
        ...
        // SPRD:ADD if not support it, remove prefence.
        if (!mIsSupportSpreakPWD) {
            mSystemsCategory.removePreference(mToggleSpeakPasswordPreference);
        }

        /*
         * SPRD: Add 20140224 Spreadst of bug282732, remove
         * tts_settings_preference if TtsEngine is lack @{
         */
        TtsEngines mTtsEngines = new TtsEngines(this.getPreferenceScreen().getContext());
        if (mTtsEngines.getEngines().isEmpty()) {
            mTtsPreferenceScreen = (PreferenceScreen) findPreference(TTS_PREFERENCE_SCREEN);
            mSystemsCategory.removePreference(mTtsPreferenceScreen);
        }
        /* @} */
        // Long press timeout.
    ...
    /* SPRD: Add 20131223 Spreadst of bug255482, soft keyboard is enlarged wrongly @{ */
    @Override
