...
public class StatusSim extends PreferenceActivity {
    ...
    private void updateNetworkType() {
        ...
        setSummaryText(KEY_NETWORK_TYPE, ServiceState.rilRadioTechnologyToString(mTelephonyManager.getVoiceNetworkType()));
        Log.d(TAG,"network type ="+mTelephonyManager.getVoiceNetworkType());
    }
