...
public class Memory extends SettingsPreferenceFragment {
    ...
    private static Preference mFormatPreference;
    ...
    public void onResume() {
        ...
        /* SPRD: DELETE delete receiver,unuesless.
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        /* SPRD: Modify Bug 313604, remove mtp ptp to sprd usb settings @{ */
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        for (StorageVolumePreferenceCategory category : mCategories) {
            ...
            if (volume != null && category.mountToggleClicked(preference)) {
                ...
                // SPRD：ADD for Settings porting from 4.1 to 4.3 on 20130917
                mFormatPreference = category.getFormatPreference();
                ...
                return new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                         // change install location,when unmount externalSdcard.
                         mInstallLocation.setEnabled(false);
                         if (getAppInstallLocation().equals(APP_INSTALL_SDCARD_ID)) {
                             handleUpdateAppInstallLocation(APP_INSTALL_DEVICE_ID);
                         }
                            doUnmount();
                        }})
    ...
    private void doUnmount() {
        ...
        try {
            ...
            // SPRD：REMOVE because of useless on 20130917
            //sLastClickedMountToggle.setTitle(getString(R.string.sd_ejecting_title));
            // SPRD：MODIFIED for Settings porting from 4.1 to 4.3 on 20130917
            sLastClickedMountToggle.setTitle(getString(R.string.sd_eject));
    ...
    //revo lgz install bug
 if(android.os.SystemProperties.get("ro.macro.app_install_path").equals("scard")){
