...
//lyx 201328 storage menu add system code 			
    ...
    public void init() {
        ...
        //lyx 201328 storage menu add system code 		 
         if(FeatureOption.PRJ_FEATURE_STORAGE_ADD_SYSTEM_CODE){
            mItemSystem = buildItem(R.string.trusted_credentials_system_tab, R.color.memory_user_dark);
    ...
    public void updateApproximate(long totalSize, long availSize) {
        ...
        //lyx 201328 storage menu add system code 		
        if(FeatureOption.PRJ_FEATURE_STORAGE_ADD_SYSTEM_CODE){	
             mItemTotal.setSummary("8GB");
             mItemSystem.setSummary("2.09GB");
        }
    ...
    public void updateDetails(MeasurementDetails details) {
	  ...
	  //lyx 201328 storage menu add system code 			
        ...
        updatePreference(mItemOthers, othersSize);
