...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        /* SPRD: add for uui createshortcut@{ */
        if (Settings.UNIVERSEUI_SUPPORT) {
            targetIntent.addCategory("com.android.settings.SHORTCUT_UUI");
        } else {
    ...
    protected List<ResolveInfo> onQueryPackageManager(Intent queryIntent) {
        ...
        // SPRD: remove SoundSettings for bug 315339 
        boolean IsSupVoice = getResources().getBoolean(com.android.internal.R.bool.
        ...
        for (int i = activities.size() - 1; i >= 0; i--) {
            ...
            /* SPRD: remove SoundSettings for bug 315339 @{ */
            if (info.activityInfo.name.endsWith(SoundSettingsActivity.class.getSimpleName())
                    && IsSupVoice) {
                activities.remove(i);
            } 
            /* @} */
