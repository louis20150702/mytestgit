...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
	...
	/* SPRD: change for uui4 widget style @{ */
    private static final int[] IND_DRAWABLE_OFF = {
        R.drawable.appwidget_settings_ind_off,
        R.drawable.appwidget_settings_ind_off,
        R.drawable.appwidget_settings_ind_off
    };

    private static final int[] IND_DRAWABLE_MID = {
        R.drawable.appwidget_settings_ind_on,
        R.drawable.appwidget_settings_ind_on,
        R.drawable.appwidget_settings_ind_on
    };
    ...
    private static final class BluetoothStateTracker extends StateTracker {
        ...
        public int getActualState(Context context) {
            if (sLocalBluetoothAdapter == null) {
                //SPRD : we should get LocalBluetoothAdapter object directly but not through LocalBluetoothManager.
                sLocalBluetoothAdapter = LocalBluetoothAdapter.getInstance();
            }
                    ...
                    if (!um.hasUserRestriction(UserManager.DISALLOW_SHARE_LOCATION)) {
                        ...
                        switch (currentMode) {
                            ...
                            case Settings.Secure.LOCATION_MODE_BATTERY_SAVING:
                                // SPRD:ADD the gps in wigdt can close.
				if(FeatureOption.PRJ_FEATURE_DEVICE_WITH_NO_GPS){
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //SPRD:ADD change the "intent" type into "String" type.
