...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
	...
	if(FeatureOption.PRJ_FEATURE_MULTI_PRJ_TRX_VID_Z40NOVA){
        ...
        //revo lyq 20141215	
	if(!FeatureOption.PRJ_FEATURE_ADD_MENU_FOR_AUTO_CHOOSE_LANGUAGE){
		 removePreference("auto_choose_language");
	}else{
            CheckBoxPreference mAutoLanguage = (CheckBoxPreference)findPreference("auto_choose_language");
            mAutoLanguage.setChecked(System.getInt(getContentResolver(),
                    Settings.System.AUTO_CHOOSE_LANGUAGE, 0) > 0);
	}
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference instanceof PreferenceScreen) {
            ...
            //revo lyq 20141215	
            else if(chkPref == findPreference("auto_choose_language")){
		  Log.d("language", "chkPref.isChecked() =" + chkPref.isChecked());
		  System.putInt(getContentResolver(), Settings.System.AUTO_CHOOSE_LANGUAGE,
                        chkPref.isChecked() ? 1 : 0);
