...
public final class BluetoothDevicePreference extends Preference implements
    ...
    public void onDeviceAttributesChanged() {
        ...
        //SPRD : when the device's attributes changed,we needn't calculate the order of preferences
    ...
    private int getBtClassDrawable() {
        ...
        /* SPRD: Device type should be firstly, then profile type, which will
         * be more correctly
         * */
        if (btClass != null) {
