...
public class SecuritySettings extends RestrictedSettingsFragment
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (KEY_UNLOCK_SET_OR_CHANGE.equals(key)) {
        ...
        } else if (KEY_SIM_LOCK.equals(key)) {
            /** SPRD: porting for pin/puk  @{ */
            ...
            if (TelephonyManager.isMultiSim()) {
                ...
                intent.putExtra(MobileSimChoose.PACKAGE_NAME, "com.android.settings");
                intent.putExtra(MobileSimChoose.CLASS_NAME, "com.android.settings.IccLockSettings");
                intent.putExtra("title_name", R.string.sim_lock_settings_ex);
                // intent.putExtra(MobileSimChooseUUI.ACTIVITY_TITLE,getString(R.string.sim_lock_settings_activity_title));
            } else {
                intent.setComponent(new ComponentName("com.android.settings", "com.android.settings.IccLockSettings"));
            }
